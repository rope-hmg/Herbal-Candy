...
pub enum Micro_Op {
    ...
    Saturating_Sub_I8(Three_Registers),
    Saturating_Mul_I8(Three_Registers),
    Saturating_Div_I8(Three_Registers),
    Saturating_Add_U8(Three_Registers),
    Saturating_Sub_U8(Three_Registers),
    Saturating_Mul_U8(Three_Registers),
    Saturating_Div_U8(Three_Registers),

    Saturating_Add_I16(Three_Registers),
    Saturating_Sub_I16(Three_Registers),
    Saturating_Mul_I16(Three_Registers),
    Saturating_Div_I16(Three_Registers),
    Saturating_Add_U16(Three_Registers),
    Saturating_Sub_U16(Three_Registers),
    Saturating_Mul_U16(Three_Registers),
    Saturating_Div_U16(Three_Registers),
    ...
    Overflowing_Add_I8(Three_Registers),
    Overflowing_Sub_I8(Three_Registers),
    Overflowing_Mul_I8(Three_Registers),
    Overflowing_Div_I8(Three_Registers),
    Overflowing_Add_U8(Three_Registers),
    Overflowing_Sub_U8(Three_Registers),
    Overflowing_Mul_U8(Three_Registers),
    Overflowing_Div_U8(Three_Registers),

    Overflowing_Add_I16(Three_Registers),
    Overflowing_Sub_I16(Three_Registers),
    Overflowing_Mul_I16(Three_Registers),
    Overflowing_Div_I16(Three_Registers),
    Overflowing_Add_U16(Three_Registers),
    Overflowing_Sub_U16(Three_Registers),
    Overflowing_Mul_U16(Three_Registers),
    Overflowing_Div_U16(Three_Registers),
