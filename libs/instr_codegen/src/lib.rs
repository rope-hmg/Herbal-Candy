...
pub static INSTRUCTIONS: &[(&str, Instr)] = &[
    ...
    instr!(r_type => "jal_r",  0b000000, 0x7, [rs2     ], { s: 1 }),
    instr!(i_type => "jal_i",  0b000000, 0x8, [imm     ]          ),
    instr!(r_type => "jnz" ,   0b000000, 0x9, [rs2, rs1], { s: 0 }),
    instr!(r_type => "jnz_r",  0b000000, 0x9, [rs2, rs1], { s: 1 }),
    instr!(i_type => "jnz_i",  0b000000, 0xA, [imm, rd ]          ),
    instr!(r_type => "jiz",    0b000000, 0xB, [rs2, rs1], { s: 0 }),
    instr!(r_type => "jiz_r",  0b000000, 0xB, [rs2, rs1], { s: 1 }),
    instr!(i_type => "jiz_i",  0b000000, 0xC, [imm, rd ]          ),
    // Memory
    // ------
    ...
    instr!(i_type => "load_i",     0b000001, 0x1, [imm, rd]              ),
    instr!(i_type => "load_a.8",   0b000001, 0x2, [imm, rd]              ),
    instr!(i_type => "load_a.16",  0b000001, 0x3, [imm, rd]              ),
    instr!(i_type => "load_a.32",  0b000001, 0x4, [imm, rd]              ),
    instr!(i_type => "load_a.64",  0b000001, 0x5, [imm, rd]              ),
    ...
    instr!(i_type => "store_i",    0b000001, 0x7, [imm, rd]              ),
    instr!(r_type => "move",       0b000001, 0x8, [rs1, rd], {          }),
    instr!(i_type => "push",       0b000001, 0x9, [     rd]              ),
    instr!(i_type => "push_i",     0b000001, 0xA, [imm    ]              ),
    ...
    instr!(r_type => "rot_l.i8",    0b000011, 0x6, [rs2, rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "rot_l.i16",   0b000011, 0x6, [rs2, rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "rot_l.i32",   0b000011, 0x6, [rs2, rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "rot_l.i64",   0b000011, 0x6, [rs2, rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "rot_l.u8",    0b000011, 0x6, [rs2, rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "rot_l.u16",   0b000011, 0x6, [rs2, rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "rot_l.u32",   0b000011, 0x6, [rs2, rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "rot_l.u64",   0b000011, 0x6, [rs2, rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "rot_r.i8",    0b000011, 0x7, [rs2, rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "rot_r.i16",   0b000011, 0x7, [rs2, rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "rot_r.i32",   0b000011, 0x7, [rs2, rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "rot_r.i64",   0b000011, 0x7, [rs2, rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "rot_r.u8",    0b000011, 0x7, [rs2, rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "rot_r.u16",   0b000011, 0x7, [rs2, rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "rot_r.u32",   0b000011, 0x7, [rs2, rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "rot_r.u64",   0b000011, 0x7, [rs2, rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "c_ones.i8",   0b000011, 0x8, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "c_ones.i16",  0b000011, 0x8, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "c_ones.i32",  0b000011, 0x8, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "c_ones.i64",  0b000011, 0x8, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "c_ones.u8",   0b000011, 0x8, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "c_ones.u16",  0b000011, 0x8, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "c_ones.u32",  0b000011, 0x8, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "c_ones.u64",  0b000011, 0x8, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "l_ones.i8",   0b000011, 0x9, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "l_ones.i16",  0b000011, 0x9, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "l_ones.i32",  0b000011, 0x9, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "l_ones.i64",  0b000011, 0x9, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "l_ones.u8",   0b000011, 0x9, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "l_ones.u16",  0b000011, 0x9, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "l_ones.u32",  0b000011, 0x9, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "l_ones.u64",  0b000011, 0x9, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "t_ones.i8",   0b000011, 0xA, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "t_ones.i16",  0b000011, 0xA, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "t_ones.i32",  0b000011, 0xA, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "t_ones.i64",  0b000011, 0xA, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "t_ones.u8",   0b000011, 0xA, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "t_ones.u16",  0b000011, 0xA, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "t_ones.u32",  0b000011, 0xA, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "t_ones.u64",  0b000011, 0xA, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "c_zeros.i8",  0b000011, 0xB, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "c_zeros.i16", 0b000011, 0xB, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "c_zeros.i32", 0b000011, 0xB, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "c_zeros.i64", 0b000011, 0xB, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "c_zeros.u8",  0b000011, 0xB, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "c_zeros.u16", 0b000011, 0xB, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "c_zeros.u32", 0b000011, 0xB, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "c_zeros.u64", 0b000011, 0xB, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "l_zeros.i8",  0b000011, 0xC, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "l_zeros.i16", 0b000011, 0xC, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "l_zeros.i32", 0b000011, 0xC, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "l_zeros.i64", 0b000011, 0xC, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "l_zeros.u8",  0b000011, 0xC, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "l_zeros.u16", 0b000011, 0xC, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "l_zeros.u32", 0b000011, 0xC, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "l_zeros.u64", 0b000011, 0xC, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "t_zeros.i8",  0b000011, 0xD, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "t_zeros.i16", 0b000011, 0xD, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "t_zeros.i32", 0b000011, 0xD, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "t_zeros.i64", 0b000011, 0xD, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "t_zeros.u8",  0b000011, 0xD, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "t_zeros.u16", 0b000011, 0xD, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "t_zeros.u32", 0b000011, 0xD, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "t_zeros.u64", 0b000011, 0xD, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "r_bytes.i8",  0b000011, 0xE, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "r_bytes.i16", 0b000011, 0xE, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "r_bytes.i32", 0b000011, 0xE, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "r_bytes.i64", 0b000011, 0xE, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "r_bytes.u8",  0b000011, 0xE, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "r_bytes.u16", 0b000011, 0xE, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "r_bytes.u32", 0b000011, 0xE, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "r_bytes.u64", 0b000011, 0xE, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    instr!(r_type => "r_bits.i8",   0b000011, 0xF, [     rs1, rd], { size: 8,  s: 1, f: 0 }),
    instr!(r_type => "r_bits.i16",  0b000011, 0xF, [     rs1, rd], { size: 16, s: 1, f: 0 }),
    instr!(r_type => "r_bits.i32",  0b000011, 0xF, [     rs1, rd], { size: 32, s: 1, f: 0 }),
    instr!(r_type => "r_bits.i64",  0b000011, 0xF, [     rs1, rd], { size: 64, s: 1, f: 0 }),
    instr!(r_type => "r_bits.u8",   0b000011, 0xF, [     rs1, rd], { size: 8,  s: 0, f: 0 }),
    instr!(r_type => "r_bits.u16",  0b000011, 0xF, [     rs1, rd], { size: 16, s: 0, f: 0 }),
    instr!(r_type => "r_bits.u32",  0b000011, 0xF, [     rs1, rd], { size: 32, s: 0, f: 0 }),
    instr!(r_type => "r_bits.u64",  0b000011, 0xF, [     rs1, rd], { size: 64, s: 0, f: 0 }),
    // Checked Arithmetic
    // ------------------
